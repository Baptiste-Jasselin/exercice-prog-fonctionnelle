...
Objectifs
---------
Créer une variable pour chaque animal du tableau et les exporter (utiliser le nom de l'animal pour nommer la variable), dans laquelle on stocke les informations de cet animal... Et écrire ça en une seule ligne !
